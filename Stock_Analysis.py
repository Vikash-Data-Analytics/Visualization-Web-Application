...
with col2:
    st.subheader("Insights - Driving Growth through Data Analytics")
...
def render_authorized_content():
    ...
    if "Open and Lowest Price" in selected_graph:
    ...
    if "Opening and Closing" in selected_graph:
    ...
    if "Lowest and Closing Price" in selected_graph:
    ...
    if "Open, High, Low, and Close Price" in selected_graph:
    ...
    # st.pie_chart(stock_data)
    if "map" in selected_graph:
        st.map()
